...
for (i in 1:50) newick_fns2[[i]]$root.edge <- 4
class(newick_fns2) <- "multiPhylo"
...
write.tree(newick_fns2[[10]], file = "glareosae11.newick")
...
if (runslow)
  {
	res = run_bears_optim_on_multiple_trees(BioGeoBEARS_run_object, newick_fns, model_name="Glareosae_DEC_MT", geog_fns, resfns, run_or_collect="run", start_treenum=1, end_treenum=length(newick_fns), runslow=TRUE, plot_params=FALSE)
...
res2 = run_bears_optim_on_multiple_trees(BioGeoBEARS_run_object, newick_fns, model_name="Glareosae_DEC_MT", geog_fns, resfns, run_or_collect="collect", start_treenum=1, end_treenum=length(newick_fns), runslow=TRUE, plot_params=FALSE)
#res2
