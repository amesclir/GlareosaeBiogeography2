...
plot(newick_fns2[[1]], cex = 0.8)
title("Example Glareosae phylogeny")
axisPhylo()

for (i in 1:50) newick_fns2[[i]]$root.edge <- 2
class(newick_fns2) <- "multiPhylo"
...
# load the saved result.
runslow = TRUE
resfn = "Glareosae_DEC_M0_constrained2_v1_ML.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
26. Plotting the results with dispesal rates and time periods and multiple trees
...
# PDF plots
#######################################################
pdffn = "Glareosae_DEC_vs_DECMT_M0_constrained2_v1.pdf"
pdf(pdffn, width=6, height=6)
...
#######################################################
# Plot ancestral states - DEC with multiple trees
#######################################################
analysis_titletxt ="BioGeoBEARS DEC MT on Glareosae M0_constrained and time periods"

# Setup
results_object = resDECc2ML
scriptdir = np(system.file("extdata/a_scripts", package="BioGeoBEARS"))
